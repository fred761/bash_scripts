...
pacman -Sy gdm gnome-session gnome-control-center gnome-tweaks gnome-terminal nautilus gedit mc eog evince fish htop gnome-boxes chromium libreoffice-fresh gimp rawtherapee papirus-icon-theme
