...
pacman -S gdm gnome-session gnome-control-center gnome-tweaks gnome-terminal nautilus gedit mc eog evince fish htop realtime-privileges xorg-xrandr xorg-xgamma flatpak firefox chromium vlc papirus-icon-theme 
