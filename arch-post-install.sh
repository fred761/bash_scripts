...
pacman -S gdm gnome-session gnome-control-center gnome-tweaks gnome-terminal nautilus gedit mc eog evince fish htop realtime-privileges xorg-xgamma chromium libreoffice-fresh vlc easyeffects zam-plugins mda.lv2 papirus-icon-theme 
